...
def train(args):
    ...
    dpath = r"C:\Users\Vasundhara\anaconda3\envs\test\image_style_transfer\Dataset"
    train_dataset = datasets.ImageFolder(os.path.join(dpath), transform=transform)
    ...
    for epoch in range(args.epochs):
        ...
        for batch_id, (x, _) in enumerate(train_loader):
            ...
            total_content_loss = total_content_loss + content_loss.item()
            total_style_loss = total_style_loss + style_loss.item()
